...
CONDITION="$CONDITION && (assertion.event_name == 'workflow_dispatch' || (assertion.event_name == 'push' && assertion.sub == 'repo:$GITHUB_REPOSITORY:environment:production') || (assertion.event_name == 'pull_request_target' && assertion.sub == 'repo:$GITHUB_REPOSITORY:environment:plan'))"
